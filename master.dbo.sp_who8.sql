...
GO
IF OBJECT_ID('dbo.sp_who8') IS NULL EXEC('CREATE PROCEDURE dbo.sp_who8 AS PRINT 1')
GO

ALTER PROCEDURE dbo.sp_who8
	...
	;with cte as(
			SELECT  
              ...
              , CASE
					...
					cast(eqp.query_plan as xml) [QueryPlan],
					'
                    ELSE
                        ''
                END
...
GO
GRANT EXECUTE ON dbo.sp_who8 TO sp_whoers;
GO
