...
SET @BackupDirectory     = CONCAT('\\', @@SERVERNAME, '\Backup')	-- Specify the backup root directory. If no directory is specified, the default backup directory is used.
...
BEGIN
  ...
  INSERT INTO @Jobs ([Name], CommandTSQL, DatabaseName, OutputFileNamePart01)
  SELECT 'UpdateStatistics - USER_DATABASES',
         'EXECUTE dbo.IndexOptimize @Databases = ''USER_DATABASES''' + CHAR(13) + CHAR(10) + ', @FragmentationLow = NULL' + CHAR(13) + CHAR(10) + ', @FragmentationMedium = NULL' + CHAR(13) + CHAR(10) + ', @FragmentationHigh = NULL' + CHAR(13) + CHAR(10) + ', @UpdateStatistics = ''ALL''' + CHAR(13) + CHAR(10) + ', @OnlyModifiedStatistics = ''Y''' + CHAR(13) + CHAR(10) + ', @MaxDOP = 0' + CHAR(13) + CHAR(10) + ', @LogToTable = ''' + @LogToTable + ''';',
         @DatabaseName,
         'UpdateStatistics'
...
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'DatabaseBackup - SYSTEM_DATABASES - FULL', @name=N'Backup_Full_System', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
...
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'DatabaseBackup - USER_DATABASES - FULL', @name=N'Backup_Full_User', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=1, 
		@freq_subday_type=1, 
...
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'DatabaseBackup - USER_DATABASES - DIFF', @name=N'Backup_Diff_User', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=126, 
		@freq_subday_type=1, 
...
EXEC msdb.dbo.sp_add_jobschedule @job_name=N'DatabaseBackup - USER_DATABASES - LOG', @name=N'Backup_Log_User', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=8, 
...
EXEC msdb.dbo.sp_add_jobschedule @job_name='UpdateStatistics - USER_DATABASES', @name=N'At 3AM', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
