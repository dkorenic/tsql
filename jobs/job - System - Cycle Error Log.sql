...
/****** Object:  Job [System - Cycle Error Log]    Script Date: 2018-02-21 14:13:19 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Server Maintenance]    Script Date: 2018-02-21 14:13:19 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'System - Cycle Error Log', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [EXEC sp_cycle_errorlog;]    Script Date: 2018-02-21 14:13:19 ******/
